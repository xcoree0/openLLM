...
// Bu satıra ulaşılması, modülün sözdizimi/çalışma zamanı hatası olmadan
// baştan sona yüklendiği anlamına gelir — sayfanın altındaki tanı betiği
// bunu kontrol ederek gerçek bir sorunda kullanıcıya açıklayıcı bir mesaj
// gösterir (bkz. index.html).
window.__openllmBooted = true;
